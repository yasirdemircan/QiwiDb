...
/*qiwiDb.setup();
qiwiDb.createDoc("Students");
qiwiDb.select("Students");

qiwiDb.addRec("Yasir");
qiwiDb.addRec("Erinç");
qiwiDb.updateRec("Yasir","gradyear","2015");
qiwiDb.updateRec("Yasir","grades",'{"math":50,"eng":100}');
qiwiDb.updateRec("Erinç","gradyear","2025");
qiwiDb.updateRec("Erinç","grades",'{"math":30,"eng":70}');
qiwiDb.updateRecNested("Erinç","grades","math","10",true);
qiwiDb.list();*/
